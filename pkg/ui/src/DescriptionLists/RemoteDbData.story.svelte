...
<Hst.Story title="Description Lists / RemoteDbData" layout={{ type: "grid", width: 600 }}>
	<Hst.Variant title="Active">
		...
		>
			<div slot="info" class="pt-2 flex flex-col gap-y-2">
				<ProgressBar />
				<p class="text-xs leading-4 font-medium uppercase text-gray-500">23 Docs Written</p>
			</div>	
		</RemoteDbData>
	</Hst.Variant>
	<Hst.Variant title="Error">
		...
		>
			<div slot="info" class="pt-2 flex flex-col gap-y-2">
				<p class="text-xs leading-4 font-medium uppercase text-gray-500">Network Error</p>
			</div>	
		</RemoteDbData>
	</Hst.Variant>
</Hst.Story>
