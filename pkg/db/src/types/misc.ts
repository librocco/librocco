...
export interface BooksInterface {
	 ...
	 */
	get(ctx: debug.DebugCtx, isbns: string[]): Promise<(BookEntry | undefined)[]>;
	/**
	 ...
	 */
	upsert(ctx: debug.DebugCtx, bookEntries: Partial<BookEntry>[]): Promise<void>;
	/**
	 ...
	 */
	streamSearchIndex(ctx?: debug.DebugCtx): Observable<SearchIndex>;
}
// #endregion books
...
export type DatabaseInterface<T = {}> = {
	 ...
	 */
	init(ctx?: debug.DebugCtx): Promise<DatabaseInterface<T>>;
	/**
	 ...
	 */
	destroy(ctx?: debug.DebugCtx): Promise<void>;
} & T;
// #endregion db
