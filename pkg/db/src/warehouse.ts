...
import { NoteData, NoteInterface, WarehouseInterface, DatabaseInterface, WarehouseData } from './types/version_1';

import { newNote } from './note';
import { WarehouseStockEntry } from './design_documents';

import { isVersioned, runAfterCondition, sortBooks, versionId, newDocumentStream, newViewStream } from './utils';
...
class Warehouse implements WarehouseInterface {
	 ...
	 */
	// eslint-disable-next-line @typescript-eslint/no-explicit-any
	private createStream<S extends (doc?: WarehouseData) => any>(
		selector: S,
		ctx: debug.DebugCtx
