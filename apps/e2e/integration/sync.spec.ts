...
test("shows incompatible state when remote DB is rebuilt and recovers after nuke and resync", async ({ page }) => {
	...
	// After a full nuke, Firefox can stay in transient reconnect states while compatibility
	// re-verification and DB re-initialisation complete. Wait for the worker to be rebound too.
