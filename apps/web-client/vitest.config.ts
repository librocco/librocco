...
function alias_vlcn_dev() {
	...
	if (process.env.CI === "true") {
		console.log("testing in CI: using vlcn.io packages installed from '3rd-party/artefacts'");
		console.log("\n");
		return {};
	}
	...
	console.log("local test mode: aliasing vlcn.io packages to respective submodules:");
