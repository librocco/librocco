...
import { reactiveDataSource } from "$lib/utils/reactive-data-source.svelte";
...
export const createLayoutDataSource = (
	rx: IAppDbRx,
	...
	return reactiveDataSource(rx, load, layoutViewDeps, initialData);
};
...
export const createOrdersViewDataSource = (
	rx: IAppDbRx,
	getDb: () => Promise<DBAsync>,
	supplierId: number,
...
export const createPublishersViewDataSource = (
	rx: IAppDbRx,
	getDb: () => Promise<DBAsync>,
	supplierId: number,
	...
	return reactiveDataSource(rx, load, publishersViewDeps, initialData);
};
