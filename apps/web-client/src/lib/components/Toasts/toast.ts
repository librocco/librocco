...
import type { ToastEntry, ToasterStore, ToastStore } from "./types";
 ...
 */
export const consume = (_toast: ToastEntry, target = "default") => {
 ...
 */
export const createToastStore = (toasterStore: ToasterStore) => (_toast: ToastEntry) => {
