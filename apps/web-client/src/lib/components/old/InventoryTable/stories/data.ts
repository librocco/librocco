/**
 * This entire file is a duplicate, but it will go anyway once we make the switch to the rehauled UI.
 */

import type { InventoryTableData, OutNoteTableData } from "$lib/components";
